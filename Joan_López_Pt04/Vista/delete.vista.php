...
<body>
    ...
    <nav>
		<ul>
			...
			<?php if( isset( $_SESSION['newsession'])):?>
				...
				<li class="active"><a href="../Vista/delete.vista.php">Delete</a></li>
    ...
    <div class="container">
        <div>
        <h1 class="box">Esborra un article</h1>
        </div>
        <div class="principalBox">
            <form action="../Controlador/delete.php" method="post">
                ...
                <br>
                <div>
                    <input type="submit" value="Enviar" onclick="return confirm('Segur que vols esborrar  aquest article?')">
                </div>
            </form>
